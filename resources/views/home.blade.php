...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/mail/mail.css">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdownactive">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="compose.html">Compose</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="../simple.html">Simple tables</a>
                        <a class="dropdown-item" href="../data.html">Data tables</a>
                        <a class="dropdown-item" href="../editable-tables.html">Editable Tables</a>
                            ...
                            <div class="mail-content inbox">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="box mb-4">
                                            ...
                                            <div class="box-body no-padding mailbox-nav">
                                                <ul class="nav nav-pills flex-column">
                                                    <li class="nav-item"><a class="nav-link active" href="#"><i class="ion ion-ios-email-outline"></i> Inbox
                                                            <span class="badge badge-success float-right">12</span></a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="ion ion-paper-airplane"></i> Sent</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="ion ion-email-unread"></i> Drafts</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="ion ion-star"></i>  Starred <span class="badge badge-danger float-right">14</span></a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="ion ion-trash-a"></i> Trash</a></li>
                                                </ul>
                                            </div><!-- /.box-body -->
                                        </div><!-- /. box -->
                                        ...
                                        <div class="box">
                                            <div class="box-header with-border">
                                                <h3 class="card-title">LSource Sans Pros</h3>
                                            </div>
                                            <div class="box-body no-padding mailbox-nav">
                                                <ul class="nav nav-pills flex-column">
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-circle-o color-danger"></i> Important</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-circle-o color-warning"></i> Promotions</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-circle-o color-success"></i> Social</a></li>
                                                </ul>
                                            </div><!-- /.box-body -->
                                        </div><!-- /.box -->
                                    </div>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="box">
                                            <div class="box-header with-border">
                                                <h3 class="card-title float-left">Inbox</h3>
                                                ...
                                                <div class="mailbox-messages">
                                                    <table class="table table-hover table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Henry Patterson</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Lisa Rios</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Joan Garrett</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Alan Carlson</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Susan Alexander</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">3 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Cynthia Robertson</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">14 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Christopher Wade</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">15 hours ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Frances Johnson</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">25 hours ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Craig Butler</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">3 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Gary Bell</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">14 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Nathan Roberts</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">15 hours ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Andrea Murray</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">25 hours ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Brittany Ellis</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">3 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Sandra Gibson</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">14 mins ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star-o color-warning"></i></a></td>
                                                            <td class="mailbox-name">Ruth Howard</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                                                            <td class="mailbox-date">15 hours ago</td>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox"></td>
                                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star color-warning"></i></a></td>
                                                            <td class="mailbox-name">Donna Curtis</td>
                                                            <td class="mailbox-subject"><a href="read-mail.html"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
                                                            </td>
                                                            <td class="mailbox-attachment"></td>
                                                            <td class="mailbox-date">25 hours ago</td>
...
<script src="../assets/js/mail/icheck.js"></script>
<script src="../assets/js/mail/mailbox.js"></script>
