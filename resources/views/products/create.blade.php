        ...
        <div class="col-md-8">
            <div class="section-content">
                <div class="content-head">
                    <h4 class="content-title">Add New Product</h4><!-- /.content-title -->
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" value="{{old('price')}}" required name="price">
                                </div>
                                @if ($errors->has('price'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" value="{{old('quantity')}}" type="number" required name="quantity">
                                </div>
