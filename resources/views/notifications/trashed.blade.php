                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body no-padding">
                                            <div class="mailbox-controls">
                                                ...
                                                <button type="button" class="btn btn-default btn-sm"><a href="{{route('notifications.trashed')}}"><i class="fa fa-refresh"></i></a></button>
                                            ...
                                            <div class="mailbox-messages">
                                                <table class="table table-hover table-striped table-responsive">
                                                    ...
                                                    @foreach($userNotifications as $userNotification)
                                                        <tr>
                                                            <td><a href="{{route('notifications.untrash', $userNotification->id)}}" title="Remove from trash"><i class="fa fa-undo"></i></a></td>
